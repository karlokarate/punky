...
class SettingsService extends ChangeNotifier {
  ...
  String get smsTarget => _prefs.getString('kidsapp_sms_target') ?? parentPhone;
  Future<void> setSmsTarget(String v) async => _set('kidsapp_sms_target', v);
