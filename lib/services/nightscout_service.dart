...
class NightscoutService extends ChangeNotifier {
  ...
  /// Liefert den aktuellsten Glukose‑Eintrag (sofern bereits gepollt).
  GlucoseEntry? getLatestGlucose() => currentEntry;

  /// Aktualisiert einmalig und liefert dann den neuesten Eintrag zurück.
  Future<GlucoseEntry?> fetchLatestGlucose() async {
    await _updateGlucose(limit: 1);
    return currentEntry;
  }
}
